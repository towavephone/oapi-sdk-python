...
class OrganizationOpLog(object):
    ...
    def __init__(self, d=None):
        ...
        self.opretor: Optional[str] = None
...
class OrganizationOpLogBuilder(object):
    ...
    def opretor(self, opretor: str) -> "OrganizationOpLogBuilder":
        self._organization_op_log.opretor = opretor
        return self

    def operation_type(self, operation_type: str) -> "OrganizationOpLogBuilder":
